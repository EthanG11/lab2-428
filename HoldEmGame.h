...
// This file also contains declarations for functions that are necessary to check for win states of a poker game.
...
//possible hands that a player may have in a game of poker
...
//function to check for hand rank
